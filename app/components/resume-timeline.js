...
const ResumeTimeline = () => {
  ...
  return (
    <div ref={timelineRef} className="timeline text-start text-text z-20 h-full">
      <div className="timeline-item mb-8 md:mb-16">
        <div className="timeline-content">
          <h2 className="hover:text-interactive text-lg md:text-xl lg:text-2xl">2022-2024</h2>
      ...
      <div className="timeline-item mb-8 md:mb-16">
        <div className="timeline-content">
          <h2 className="hover:text-interactive text-lg md:text-xl lg:text-2xl">2019-2022</h2>
          <p className="text-md md:text-lg">Developer Lead</p>
          <p className="text-interactive text-sm md:text-base">Radial Development Group</p>
          <ul className="mt-2 flex flex-wrap lg:flex-nowrap space-x-2">
      ...
      <div className="timeline-item mb-8 md:mb-16">
        <div className="timeline-content">
          <h2 className="hover:text-interactive text-lg md:text-xl lg:text-2xl">2018-2019</h2>
          <p className="text-md md:text-lg">Full Stack Software Engineer</p>
          <p className="text-interactive text-sm md:text-base">Origin Protocol</p>
          <ul className="mt-2 flex flex-wrap lg:flex-nowrap space-x-2">
      ...
      <div className="timeline-item mb-8 md:mb-16">
        <div className="timeline-content">
          <h2 className="hover:text-interactive text-lg md:text-xl lg:text-2xl">2017-2018</h2>
          <p className="text-md md:text-lg">Developer Lead</p>
          <p className="text-interactive text-sm md:text-base">Radial Development Group</p>
          <ul className="mt-2 flex flex-wrap lg:flex-nowrap space-x-2">
            <SkillBubble text="React" />
